...
export type ObjectChangedDelegate<TObject extends object | boolean | undefined> = (newObject: TObject) => void

export class CorgiObjectChangedEvent<TObject extends object | boolean | undefined> {
