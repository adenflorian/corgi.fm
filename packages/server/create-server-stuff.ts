...
function getMelodyNotes() {
	return makeSequencerEvents([
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 0, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 1, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 2, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 3, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 4, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 5, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 6, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 7, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 8, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 9, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 10, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 11, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 12, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 13, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 14, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 15, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 16, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 17, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 18, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 19, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 20, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 21, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 22, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 23, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 24, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 25, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 26, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 27, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 28, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 29, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([48]), startBeat: 30, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([]), startBeat: 31, durationBeats: 1}),
	])
}

function getInitialInfiniteSequencerEvents() {
	return makeSequencerEvents([
		makeMidiClipEvent({notes: MidiNotes([60]), startBeat: 0, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([67]), startBeat: 1, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([74]), startBeat: 2, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([76]), startBeat: 3, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([60]), startBeat: 4, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([67]), startBeat: 5, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([74]), startBeat: 6, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([76]), startBeat: 7, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([60]), startBeat: 8, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([67]), startBeat: 9, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([74]), startBeat: 10, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([76]), startBeat: 11, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([60]), startBeat: 12, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([67]), startBeat: 13, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([74]), startBeat: 14, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([76]), startBeat: 15, durationBeats: 1}),

		makeMidiClipEvent({notes: MidiNotes([58]), startBeat: 16, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([65]), startBeat: 17, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([72]), startBeat: 18, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([70]), startBeat: 19, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([58]), startBeat: 20, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([65]), startBeat: 21, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([72]), startBeat: 22, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([70]), startBeat: 23, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([58]), startBeat: 24, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([65]), startBeat: 25, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([72]), startBeat: 26, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([70]), startBeat: 27, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([58]), startBeat: 28, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([65]), startBeat: 29, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([72]), startBeat: 30, durationBeats: 1}),
		makeMidiClipEvent({notes: MidiNotes([70]), startBeat: 31, durationBeats: 1}),
	])
}
