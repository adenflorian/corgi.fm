...
const testClip = makeMidiClip({
	...
	loop: true,
	events: List([
		makeMidiClipEvent({startBeat: 0.0, note: 60}),
		makeMidiClipEvent({startBeat: 0.25, note: 64}),
		makeMidiClipEvent({startBeat: 1.0, note: 67}),
		makeMidiClipEvent({startBeat: 1.5, note: 71}),
		makeMidiClipEvent({startBeat: 1.99, note: 72}),
		makeMidiClipEvent({startBeat: 2.0, note: 71}),
	]),
})
			...
			([
				{
					...
					events: List<MidiGlobalClipEvent>([
						makeMidiGlobalClipEvent({startTime: 0.0, note: 60}),
						makeMidiGlobalClipEvent({startTime: 0.25, note: 64}),
						makeMidiGlobalClipEvent({startTime: 1.0, note: 67}),
						makeMidiGlobalClipEvent({startTime: 1.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 1.99, note: 72}),
						makeMidiGlobalClipEvent({startTime: 2.0, note: 71}),
					]),
					bpm: 60,
				...
				},
				{
					...
					expected: List<MidiGlobalClipEvent>([
						makeMidiGlobalClipEvent({startTime: 0.0, note: 60}),
						makeMidiGlobalClipEvent({startTime: 0.375, note: 64}),
						makeMidiGlobalClipEvent({startTime: 1.5, note: 67}),
						makeMidiGlobalClipEvent({startTime: 2.25, note: 71}),
						makeMidiGlobalClipEvent({startTime: 2.985, note: 72}),
						makeMidiGlobalClipEvent({startTime: 3.0, note: 71}),
					]),
				},
			] as Array<{
				name: string,
			...
			[
				{
					name: '0 range - 0.00',
					start: 0.00,
					expected: [makeMidiGlobalClipEvent({startTime: 0.0, note: 60})],
				},
				{
					name: '0 range - 0.25',
					start: 0.25,
					expected: [makeMidiGlobalClipEvent({startTime: 0.00, note: 64})],
				},
				{
					name: '0 range - 1.00',
					start: 1.00,
					expected: [makeMidiGlobalClipEvent({startTime: 0.00, note: 67})],
				},
				{
					name: '0 range - 2.00',
					start: 2.00,
				...
				},
				{
					name: '0 range - 3.99',
					start: 3.99,
					expected: [makeMidiGlobalClipEvent({startTime: 0.00, note: 72})],
				},
				...
				},
				{
					...
					expected: [
						makeMidiGlobalClipEvent({startTime: 0.00, note: 60}),
						makeMidiGlobalClipEvent({startTime: 0.25, note: 64}),
					],
				},
				...
				},
				{
					...
					expected: [
						makeMidiGlobalClipEvent({startTime: 0.0, note: 67}),
						makeMidiGlobalClipEvent({startTime: 0.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 0.99, note: 72}),
					],
				},
				{
				...
				},
				{
					...
					expected: [
						...
						makeMidiGlobalClipEvent({startTime: 0.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 0.99, note: 72}),
						makeMidiGlobalClipEvent({startTime: 1.0, note: 60}),
						makeMidiGlobalClipEvent({startTime: 1.25, note: 64}),
					],
				},
				{
					...
					expected: [
						...
						makeMidiGlobalClipEvent({startTime: 1.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 1.99, note: 72}),
						makeMidiGlobalClipEvent({startTime: 2.0, note: 60}),
						makeMidiGlobalClipEvent({startTime: 2.25, note: 64}),
						makeMidiGlobalClipEvent({startTime: 3.0, note: 67}),
						makeMidiGlobalClipEvent({startTime: 3.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 3.99, note: 72}),
					],
				},
				{
					...
					expected: [
						...
						makeMidiGlobalClipEvent({startTime: 3.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 3.99, note: 72}),
						makeMidiGlobalClipEvent({startTime: 4.0, note: 60}),
						makeMidiGlobalClipEvent({startTime: 4.25, note: 64}),
						makeMidiGlobalClipEvent({startTime: 5.0, note: 67}),
						makeMidiGlobalClipEvent({startTime: 5.5, note: 71}),
						makeMidiGlobalClipEvent({startTime: 5.99, note: 72}),
					],
				},
				{
